/* ==========================================================================
   ...
   ⚠️ **مكتبة Supabase تُحمَّل عند الطلب لا مع الصفحة.** اللعبة تعمل بلا
   إنترنت وهذا وعد معلن في المتجر وفي `sw.js`؛ ووسم <script> لمكتبة على CDN
   يعني نداء شبكة فاشلاً في كل إقلاع لمن يلعب محلياً بلا اتصال. فلا تُجلب
   إلا حين يضغط اللاعب «أونلاين» فعلاً.
   ========================================================================== */
